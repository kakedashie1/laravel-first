                                  ...
                                  <div class="p-2 w-full">
                                    <div class="relative">
                                      ...
                                      <select name="age">
                                        ...
                                        <option value="1" @if($contact->age == 1 ) selected  checked @endif>~19歳</option>
                                        <option value="2" @if($contact->age == 2 ) selected  checked @endif>20歳~29歳</option>
                                        <option value="3" @if($contact->age == 3 ) selected  checked @endif>29歳~39歳</option>
                                        <option value="4" @if($contact->age == 4 ) selected  checked @endif>39歳~49歳</option>
                                        <option value="5" @if($contact->age == 5 ) selected  checked @endif>49歳~59歳</option>
                                        <option value="6" @if($contact->age == 6 ) selected  checked @endif>60歳~</option>
                                      </select>
                                    </div>
                                  </div>
                              <div class="p-2 w-full">
